...
<form method="post" action="<?php echo htmlspecialchars ($_SERVER["PHP_SELF"]);?>">
    ...
    <div id="form">
        ...
        <br>
            ...
            <div id="weight"> <p>Size <span class="error">* <?php echo $weightErr;?></span> </p> 
            ...
            <li><input type="radio" name="weight" <?php if (isset($weight)  && $weight=="xlarge") echo "checked";?> value="xlarge"> < 50 lbs</li> 
                ...
                <!-- <select id="selectWeight">
                    ...
                    <option value="XL">X Large (< 51 lbs)</option>
                </select> -->
        ...
        <!-- comment section -->
            <div id="comment"> <p>Details about your dog:</p>
